...
| Platform | File |
|---|---|
| **macOS** | `Dialektik_macOS_v1.0.1.dmg` — open and drag to Applications |
| **iOS & iPadOS** | `Dialektik_iOS_iPadOS_v1.0.1.ipa` — install via TestFlight or sideload |
| **Web** | `Dialektik_web_v1.0.1.zip` — extract and serve the `Dialektik/` folder |
...
```bash
unzip Dialektik_web_v1.0.1.zip
...
npx create-dmg build/macos/Build/Products/Release/Dialektik.app Dialektik_macOS_v1.0.1.dmg
```
