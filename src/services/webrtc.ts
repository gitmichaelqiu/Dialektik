...
export interface PeerMessage {
  type: "handshake" | "yjs-sync-step-1" | "yjs-sync-step-2" | "yjs-update" | "timer-action" | "version-reject" | "pairing-request" | "vault-sync" | "join-request" | "session-state" | "shared-docs-sync";
  version?: string;
  senderId: string;
  payload?: any;
}
